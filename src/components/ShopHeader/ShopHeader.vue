<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="toggleActivityList">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-if="showShopMsg">
    ...
    <transition name="fade">
      <div class="activity-sheet" v-if="activityListShow">
...
export default {
  ...
  methods: {
    toggleShopMsg () {
      this.showShopMsg = !this.showShopMsg
    },
    toggleActivityList () {
